					...
					if ( function_exists( 'the_custom_logo' ) ) {
						if ( has_custom_logo() ) {
							...
							if ( $header_textcolor !== 'blank' ):
								?>
								<a class="site-title"
								   href="<?php echo esc_url( get_home_url() ) ?>"> <?php echo esc_html( get_option( 'blogname', '' ) ) ?></a>
							<?php endif; ?>
							<?php
							...
							<div class="menu-all-pages-container">
								<ul id="primary-menu" class="menu nav-menu" aria-expanded="false">
									<?php if ( current_user_can( 'administrator' ) ): ?>
										<li>
											<a href="<?php echo esc_url( admin_url( 'nav-menus.php' ) ); ?>"><?php echo esc_html__( 'Add a menu', 'Rishi' ); ?></a>
										</li>
									<?php else: ?>
										<li>
											<a href="<?php echo esc_url( get_home_url() ); ?>"><?php echo esc_html__( 'Home', 'Rishi' ); ?></a>
										</li>
									<?php endif; ?>
								</ul>
							</div>
